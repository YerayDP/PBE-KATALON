...
WebUI.click(findTestObject('Object Repository/Page_Porsche - Worldwide/div_France'))

WebUI.selectOptionByValue(findTestObject('Page_Porsche/select_M1                    M2            _7fab48'), 'dealersView_v2.php?surveyOrder=3&fm=3&sm=4&idRegion=10', 
    false)
